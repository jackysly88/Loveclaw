...
function gpbp(phone){return lp().find(p=>p.phone===phone)||null}
...
module.exports={loadLocalProfiles:lp,saveLocalProfiles:sp,loadMatches:lm,saveMatches:sm,getProfile:gp,getProfileByPhone:gpbp,getAllProfiles:ga,addMatch:am,getUnreportedMatches:gum,markMatchReported:mmr,saveProfile:ap,deleteProfile:dp};
